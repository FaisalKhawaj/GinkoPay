  ...
  return (
      <Modal 
        ...
        <View style={styles.mainview}>
          ...
          <Text style={{color:"#fff" , paddingHorizontal:20, textAlign:"left", fontSize:14, fontFamily:simpletext }}>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</Text>
