  ...
  return (
    <Container style={styles.container}>
      <Content style={{ flexGrow: 1 }}  >
        <Header />
        <Text style={{ color: bluetext, marginVertical: 10, alignSelf: "center" }}> Create Your Acccount</Text>
        <TextInput
          label={"Name"}
          theme={theme}
          mode="outlined"
        ...
        />
        <Text style={{ color: graycolor, marginHorizontal: 10, }}>Username <Text style={{ color: bluetext }}>Available</Text></Text>
        <TextInput
          label={"Email"}
          theme={theme}
          mode="outlined"
